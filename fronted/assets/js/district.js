...
chhattisgarh: {
   ...
   'madhya-pradesh': {
    ...
    topPlaces: [
        ...
        { name: 'Orchha', img: 'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/11/1a/0c/46/photo4jpg.jpg?w=2200&h=-1&s=1', desc: 'Historic riverside town famous for palaces, temples, cenotaphs, forts, and Bundela architectural heritage.' },
    ...
    morePlaces: [
        { name: 'Maheshwar', img: 'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/0d/ee/82/d3/20161103-130702-largejpg.jpg?w=1200&h=900&s=1', desc: 'Historic Narmada riverside town famous for Ahilya Fort, temples, ghats, handloom traditions, and Maheshwari sarees.' },
        { name: 'Omkareshwar', img: 'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/06/c5/80/e2/river-2.jpg?w=1200&h=-1&s=1', desc: 'Sacred island pilgrimage destination famous for Omkareshwar Jyotirlinga, Narmada ghats, temples, and spiritual heritage.' },
        { name: 'Amarkantak', img: 'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/09/8c/66/a2/ancient-temples-of-kalachuri.jpg?w=1400&h=800&s=1', desc: 'Sacred hill destination known as the source of the Narmada River, with temples, waterfalls, forests, and pilgrimage sites.' },
        { name: 'Shivpuri', img: 'https://www.holidify.com/images/cmsuploads/compressed/ChhatriShivpuri_20191203131621_20191203131647.jpg', desc: 'Historic city known for royal cenotaphs, lakes, Madhav National Park, palaces, and forest landscapes.' },
        { name: 'Chanderi', img: 'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/13/df/9c/a5/taal.jpg?w=1200&h=-1&s=1', desc: 'Historic town famous for forts, palaces, mosques, ancient monuments, and traditional Chanderi handloom sarees.' },
        ...
        { name: 'Vidisha', img: 'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/05/7a/a6/74/maladevi-temple.jpg?w=800&h=-1&s=1', desc: 'Ancient city surrounded by archaeological sites, historic temples, monuments, caves, and cultural heritage.' },
        ...
        { name: 'Kanha National Park', img: 'https://dynamic-media-cdn.tripadvisor.com/media/photo-s/01/7f/88/68/kanha-national-park.jpg?w=600&h=-1&s=1', desc: 'One of India’s most famous tiger reserves, known for wildlife safaris, forests, grasslands, barasingha, and rich biodiversity.' },
        ...
        { name: 'Neemuch', img: 'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/15/4c/18/e6/beauty-of-gandhisagar.jpg?w=1400&h=-1&s=1', desc: 'Regional destination known for temples, historic sites, nearby waterfalls, reservoirs, and natural landscapes.' },
